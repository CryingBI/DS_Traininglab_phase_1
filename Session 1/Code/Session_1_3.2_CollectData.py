...
def gather_20newsgroups_data():
    path = "C:\Users\Admin\DS_Traininglab_phase_1\Session 1\Data"
    dirs = [path + dir_name + '\\'
    ...
    with open("C:\Users\Admin\DS_Traininglab_phase_1\Session 1\Data\stop_word") as f:
    ...
    with open("C:\Users\Admin\DS_Traininglab_phase_1\Session 1\Data\20news-train-processed.txt", 'w') as f:
        f.write('\n'.join(train_data))
    with open("C:\Users\Admin\DS_Traininglab_phase_1\Session 1\Data\20news-test-processed.txt", 'w') as f:
        f.write('\n'.join(test_data))
    with open("C:\Users\Admin\DS_Traininglab_phase_1\Session 1\Data\20news-full-processed.txt", 'w') as f:
        f.write('\n'.join(full_data))
